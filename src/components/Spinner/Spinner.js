...
import CSS from './_components.spinner-css';

function Spinner ({ isInverted = false }) {
  const classes = isInverted ? 'demo-spinner__flap--inverted' : 'demo-spinner__flap';
